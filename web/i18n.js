...
(function () {
  ...
  const TR = {
    de: {
      ...
      'consent.intro':         'Bevor MSFSVoiceWalker loslegt, hier was im Hintergrund passiert. Keine langen AGB, nur das Wichtige:',
    ...
    en: {
      ...
      'consent.intro':         'Before MSFSVoiceWalker starts, here is what happens behind the scenes. No long ToS, just the essentials:',
