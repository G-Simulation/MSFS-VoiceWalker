...
(function () {
  ...
  const TR = {
    de: {
      ...
      'mesh.private.new_help': 'Der Code besteht aus sechs Wörtern des Funkalphabets und lässt sich so am Funk durchgeben.',
    ...
    en: {
      ...
      'mesh.private.new_help': 'The code is six words from the phonetic alphabet, so you can read it out over the radio.',
    ...
    nl: {
      ...
      'mesh.private.new_help': 'De code bestaat uit zes woorden van het spellingsalfabet en is zo over de radio door te geven.',
